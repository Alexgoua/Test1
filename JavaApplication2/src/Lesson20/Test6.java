...
public class Test6 {
    public static void main(String[] args) {
        ...
        System.out.println();
        list1.get(0).append("!!!");//это изменение отобразится на клоннированном объекте
        System.out.println(list2.get(0));
        list1.set(0, new StringBuilder("D"));//это изменение НЕ отобразится на клоннированном объекте
        System.out.println(list2.get(0));
        System.out.println();
